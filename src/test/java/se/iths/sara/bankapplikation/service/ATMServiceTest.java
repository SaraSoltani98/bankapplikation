package se.iths.sara.bankapplikation.service;
...
import se.iths.sara.bankapplikation.component.AccountComponent;
import se.iths.sara.bankapplikation.exception.InsufficientFundsException;
import se.iths.sara.bankapplikation.exception.InvalidAmountException;
import se.iths.sara.bankapplikation.exception.MaxWithdrawalExceededException;
...
public class ATMServiceTest {
    ...
    @Test
    void withdrawShouldThrowWhenAmountIsZeroOrNegative() {
        assertThrows(InvalidAmountException.class, () -> atmService.withdraw(0));
        assertThrows(InvalidAmountException.class, () -> atmService.withdraw(-10));
    ...
    @Test
    void getBalanceShouldReturnBalanceFromComponent() {
        when(accountComponent.getBalance()).thenReturn(123);

        int result = atmService.getBalance();

        org.junit.jupiter.api.Assertions.assertEquals(123, result);
